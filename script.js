document.addEventListener('DOMContentLoaded', function() {
    ...
    if (contactForm) {
        const showError = (input, message) => {
            ...
            errorSpan.style.cssText = 'color: #dc3545; font-size: 0.875rem; margin-top: 0.25rem; display: block;';
        ...
        const validateField = (input) => {
            ...
            if (value && type === 'tel' && !/^[\d\s\-\+\(\)]{7,}$/.test(value)) {
            ...
            if (isValid) {
                ...
                if (submitBtn) {
                    ...
                    setTimeout(() => {
                        ...
                        successMsg.style.cssText = 'color: #28a745; padding: 1rem; margin-top: 1rem; text-align: center;';
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: 'db099680-3b68-44b3-8555-7698081697cc',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || 'db099680-3b68-44b3-8555-7698081697cc';
...
// The CTA button uses a standard anchor link with target="_blank".
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = 'db099680-3b68-44b3-8555-7698081697cc';
